...
mxscript(drawDevUrl + 'js/diagramly/GitHubEnterpriseFile.js');
mxscript(drawDevUrl + 'js/diagramly/GitHubEnterpriseLibrary.js');
mxscript(drawDevUrl + 'js/diagramly/GitHubEnterpriseClient.js');
